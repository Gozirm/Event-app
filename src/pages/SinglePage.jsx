...
const SinglePage = () => {
  ...
  const totalPrice =
    event?.price?.reduce((acc, ticket) => acc + ticket.price, 0) || 0;
  ...
  return (
    <>
      <main className="single-page">
        ...
        <img src={event.image} alt="" className="single-page-img mt-4" />
              ...
              <div className="my-3 event-tag-div">
                {event?.tags?.length > 0 ? (
                  event.tags.map((eventTag) => (
                    <p key={eventTag} className="event-tags">
                      {eventTag}
                    </p>
                  ))
                ) : (
